...
Smartphone Compatible web template, free webdesigns for Nokia, Samsung, LG, SonyEricsson, Motorola web design" />
    <link rel="stylesheet" href="https://p.w3layouts.com/demos/blogger/web/css/style.css">
    ...
    <link href='https://p.w3layouts.com/demos/blogger/web/css/bootstrap.css' rel='stylesheet' type='text/css'>
    <script src="https://a.vdo.ai/core/v-w3layouts/vdo.ai.js"></script>
            ...
            <div class="banner">
                <div  class="callbacks_container">
                    <ul class="rslides" id="slider4">
                        <li>
                            <img src="{{ asset('assets/admin/img/images/1.jpg') }}" class="img-responsive" alt="" />

                        </li>
                        <li>
                            <img src="{{ asset('assets/admin/img/images/2.jpg') }}" class="img-responsive" alt="" />


                        </li>
                        <li>
                            <img src="{{ asset('assets/admin/img/images/3.jpg') }}" class="img-responsive" alt="" />
...
{{--                <script src="js/responsiveslides.min.js"></script>--}}
            ...
            <div class="top-news">
                ...
                <div class="top-inner">
                    <div class="col-md-6 top-text">
                        <a href="single.html"><img src="{{ asset('assets/admin/img/images/pic1.jpg') }}" class="img-responsive" alt=""></a>
                    ...
                    <div class="col-md-6 top-text two">
                        <a href="single.html"><img src="{{ asset('assets/admin/img/images/pic2.jpg') }}" class="img-responsive" alt=""></a>
                        <h5 class="top"><a href="single.html">Consetetur sadipscing elit</a></h5>
                        <p>Consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt labore dolore magna aliquyam eratsed diam justo duo dolores rebum.</p>
                ...
                <div class="top-inner second">
                    <div class="col-md-6 top-text">
                        <a href="single.html"><img src="{{ asset('assets/admin/img/images/pic3.jpg') }}" class="img-responsive" alt=""></a>
                        <h5 class="top"><a href="single.html">Consetetur sadipscing elit</a></h5>
                        <p>Consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt labore dolore magna aliquyam eratsed diam justo duo dolores rebum.</p>
                        <p>On Jun 25 <a class="span_link" href="#"><span class="glyphicon glyphicon-comment"></span>0 </a><a class="span_link" href="#"><span class="glyphicon glyphicon-eye-open"></span>56 </a><a class="span_link" href="single.html"><span class="glyphicon glyphicon-circle-arrow-right"></span></a></p>
                    </div>
                    <div class="col-md-6 top-text two">
                        <a href="single.html"><img src="{{ asset('assets/admin/img/images/pic4.jpg') }}" class="img-responsive" alt=""></a>
                        <h5 class="top"><a href="single.html">Consetetur sadipscing elit</a></h5>
                        <p>Consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt labore dolore magna aliquyam eratsed diam justo duo dolores rebum.</p>
                        <p>On Jun 27 <a class="span_link" href="#"><span class="glyphicon glyphicon-comment"></span>0 </a><a class="span_link" href="#"><span class="glyphicon glyphicon-eye-open"></span>56 </a><a class="span_link" href="single.html"><span class="glyphicon glyphicon-circle-arrow-right"></span></a></p>
                    </div>
            ...
            <div class="general-news">
                <div class="general-inner">
                    <div class="general-text">
                        <a href="single.html"><img src="{{ asset('assets/admin/img/images/gen1.jpg') }}" class="img-responsive" alt=""></a>
                        <h5 class="top"><a href="single.html">Consetetur sadipscing elit</a></h5>
                        <p>Consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt labore dolore magna aliquyam eratsed diam justo duo dolores rebum.</p>
                        <p>On Jun 25 <a class="span_link" href="#"><span class="glyphicon glyphicon-comment"></span>0 </a><a class="span_link" href="#"><span class="glyphicon glyphicon-eye-open"></span>56 </a><a class="span_link" href="single.html"><span class="glyphicon glyphicon-circle-arrow-right"></span></a></p>
                    </div>
                    <div class="edit-pics">
                        <div class="editor-pics">
                            <div class="col-md-3 item-pic">
                                <img src="{{ asset('assets/admin/img/images/f4.jpg') }}" class="img-responsive" alt="">
                        ...
                        <div class="editor-pics">
                            <div class="col-md-3 item-pic">
                                <img src="{{ asset('assets/admin/img/images/f1.jpg') }}" class="img-responsive" alt="">
                    ...
                    <div class="media">
                        ...
                        <div class="general-text two">
                            <a href="single.html"><img src="{{ asset('assets/admin/img/images/gen3.jpg') }}" class="img-responsive" alt=""></a>
                            <h5 class="top"><a href="single.html">Consetetur sadipscing elit</a></h5>
                            <p>Consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt labore dolore magna aliquyam eratsed diam justo duo dolores rebum.</p>
                            <p>On Jun 27 <a class="span_link" href="#"><span class="glyphicon glyphicon-comment"></span>0 </a><a class="span_link" href="#"><span class="glyphicon glyphicon-eye-open"></span>56 </a><a class="span_link" href="single.html"><span class="glyphicon glyphicon-circle-arrow-right"></span></a></p>
                        </div>
                    ...
                    <div class="general-text two">
                        <a href="single.html"><img src="{{ asset('assets/admin/img/images/gen2.jpg') }}" class="img-responsive" alt=""></a>
                        <h5 class="top"><a href="single.html">Consetetur sadipscing elit</a></h5>
                        <p>Consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt labore dolore magna aliquyam eratsed diam justo duo dolores rebum.</p>
                        <p>On Jun 27 <a class="span_link" href="#"><span class="glyphicon glyphicon-comment"></span>0 </a><a class="span_link" href="#"><span class="glyphicon glyphicon-eye-open"></span>56 </a><a class="span_link" href="single.html"><span class="glyphicon glyphicon-circle-arrow-right"></span></a></p>
                    </div>
        ...
        <div class="copy">
            <p>&copy; 2018 - {{ date('Y') }} Blogger. All Rights Reserved | Design by <a href="http://w3layouts.com/">W3layouts</a> </p>
        </div>
        <div class="clearfix"> </div>
    </div>
    <div class="clearfix"> </div>
