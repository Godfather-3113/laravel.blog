...
@section('title', 'Blogger a Blogging Category  | Home :: w3layouts')
    ...
    <div class="banner-section">
        ...
        <div class="banner">
            ...
            <div class="b-bottom">
                ...
                <p>On Aug 25 <a class="span_link" href="#"><span class="glyphicon glyphicon-comment"></span>0 </a><a
                    ...
                    @foreach($posts as $post)
                        <div class="col-md-6 top-text">
                            ...
                            <p>On {{ $post->getPostDate() }}
                                <a class="span_link" href="{{ route('categories.single', ['slug' => $post->category->slug]) }}"><span class="glyphicon glyphicon-flag"></span> {{ $post->category->slug }} </a>
                                <a class="span_link" href="#"><span class="glyphicon glyphicon-comment"></span>0</a>
                                <a class="span_link" href="#"><span class="glyphicon glyphicon-eye-open"></span>{{ $post->views }}</a>
                                <a class="span_link" href="{{ route('posts.single', ['slug'=> $post->slug]) }}"><span class="glyphicon glyphicon-circle-arrow-right"></span></a>
                            </p>
                        </div>
                    @endforeach
                    <div class="clearfix"></div>
