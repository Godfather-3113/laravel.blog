...
{{--           <ul class="cl-effect-16 top-nag auth">--}}
{{--                           <li class="@if(\Illuminate\Support\Facades\Auth::check()) hidden @endif" ><a href="{{ route('register.store') }}" data-hover="Registration">Registration</a></li>--}}
{{--                           <li class="@if(\Illuminate\Support\Facades\Auth::user()) hidden @endif"><a href="{{ route('login.create') }}" data-hover="Login">Login</a></li>--}}
{{--           </ul>--}}
